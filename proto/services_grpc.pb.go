...
const (
	...
	AppServices_GetLinks_FullMethodName               = "/endpoints.fcs.v1.AppServices/GetLinks"
)
...
type AppServicesClient interface {
	...
	GetLinks(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*Links, error)
}
...
func (c *appServicesClient) GetLinks(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*Links, error) {
	out := new(Links)
	err := c.cc.Invoke(ctx, AppServices_GetLinks_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type AppServicesServer interface {
	...
	GetLinks(context.Context, *emptypb.Empty) (*Links, error)
...
func (UnimplementedAppServicesServer) GetLinks(context.Context, *emptypb.Empty) (*Links, error) {
...
func _AppServices_GetLinks_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(emptypb.Empty)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AppServicesServer).GetLinks(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: AppServices_GetLinks_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AppServicesServer).GetLinks(ctx, req.(*emptypb.Empty))
	}
	return interceptor(ctx, in, info, handler)
}
...
var AppServices_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "GetLinks",
			Handler:    _AppServices_GetLinks_Handler,
		},
	},
